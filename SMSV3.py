...
Write.Print('Bản Quyền: TRẦN ĐĂNG ĐỒNG '+'\n' ,Colors.red_to_yellow, interval=0.005)
Write.Print('Zalo: 0975013450 '+'\n' ,Colors.red_to_yellow, interval=0.005)
Write.Print('Facebook: https://www.facebook.com/dangdongit.info '+'\n' ,Colors.red_to_yellow, interval=0.005)
Write.Print('==========================================================================='+'\n' ,Colors.red_to_yellow, interval=0.005)
